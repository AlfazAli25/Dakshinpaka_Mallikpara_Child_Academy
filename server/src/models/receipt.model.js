...
const receiptSchema = new mongoose.Schema(
  {
    ...
    receiptType: { type: String, enum: ['FEE', 'SALARY', 'NOTICE'], required: true, index: true },
    ...
    noticeId: { type: mongoose.Schema.Types.ObjectId, ref: 'Notice', index: true },
    noticePaymentId: { type: mongoose.Schema.Types.ObjectId, ref: 'NoticePayment', index: true, unique: true, sparse: true },
    ...
    noticeTitle: { type: String, trim: true },
    amount: { type: Number, required: true, min: 0 },
    amountPaid: { type: Number, min: 0 },
    monthlySalary: { type: Number, min: 0 },
    pendingSalary: { type: Number, min: 0 },
