...
export default function DashboardHero3D() {
  return (
    <div className="relative h-[240px] w-full overflow-hidden rounded-3xl border border-red-200/80 bg-gradient-to-br from-white via-red-50/65 to-red-100/80 shadow-[0_30px_70px_-40px_rgba(153,27,27,0.7)] dark:border-red-400/20 dark:from-slate-900 dark:via-slate-900 dark:to-red-950/40">
      <motion.div
      ...
      <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-white/75 to-transparent dark:from-slate-900/70" />
